...
@SpringBootTest(classes = ArtajaSpringBoot1Application.class, webEnvironment = WebEnvironment.DEFINED_PORT)
public class SpringBootBootstrapIntegrationTest {

	@Before
	public void setUp() {
		RestAssured.authentication = preemptive().basic("aryan", "pass@123");
	}
